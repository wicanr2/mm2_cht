...
共 609 個符號：599 個在 `docs/` 有筆記，10 個只出現在程式碼註解裡。
...
| `sub_3836` | 素材已定位**：ROM `0x06D05C` 的 53 個 tile，`sub_3836` 依視野格子值 3 直接動 nametable（不進組合緩衝區），火焰顏色是逐幀換 CRAM 第 3 條的第 5–7 格、不吃光… | `docs/research/02-other-platforms.md:1216`, `docs/todo.md:59` |
...
| `sub_4486` | `sub_4486`（開機）把三個指標存進 a5 變數： | `docs/research/02-other-platforms.md:878` |
...
| `sub_B880` | 調暗的迴圈在 `0x8242` 與 `sub_B880`，兩支的算式一樣 —— 逐色取出三個 3-bit | `docs/research/02-other-platforms.md:1117`, `docs/research/02-other-platforms.md:1132`, `docs/research/02-other-platforms.md:1146` 等 5 處 |
...
| `sub_FB86` | 表在 `-$35D2(a5)`，**52 個長字**，由 `sub_FC38` 依區域類型（`sub_FB86(地圖編號)`） | `docs/music.md:157`, `docs/research/02-other-platforms.md:899`, `docs/research/02-other-platforms.md:996` 等 12 處 |
...
| `sub_13928` | 接完**：三十二種全部接進 `internal/game/special.go`（[`polish-spec`](polish-spec.md) P18）。`ds:1436` 減 `0x11` 那一步也解掉了 —— 傷… | `docs/formats/07-event-script.md:740`, `docs/formats/07-event-script.md:748`, `docs/polish-spec.md:29` 等 9 處 |
| `sub_13A64` | 擲 < 0x60 且 技能 >= 擲 → sub_13A64 開門 + 訊息 4（Success!） | `docs/formats/06-map.md:80`, `docs/formats/06-map.md:395`, `docs/polish-spec.md:17` 等 8 處 |
...
| `sub_13E82` | 再呼叫 `sub_13E82` 與 thunk `0x172A6`（2PLAY `+B75E`）重畫。 | `docs/re/05-2smith-control-room.md:80` |
...
| `sub_16DBA` | `sub_16DBA` | `docs/re/05-2smith-control-room.md:285` |
...
| `sub_16F3A` | `sub_16F3A` | `docs/re/05-2smith-control-room.md:281` |
...
| `sub_1701E` | `sub_1701E`／`sub_1702A` | `docs/re/09-2combat-map.md:388` |
| `sub_1702A` | `sub_1701E`／`sub_1702A` | `docs/re/09-2combat-map.md:388` |
...
| `sub_170AE` | `sub_170AE` | `docs/re/09-2combat-map.md:389` |
...
| `sub_17186` | `sub_17186` | `docs/re/09-2combat-map.md:390` |
| `sub_171CE` | 戰鬥中用物品：走 `2CAST1` 的施法入口或 `sub_171CE` 的即時效果 | `docs/re/08-2cmds-inventory.md:160`, `docs/re/09-2combat-map.md:426` |
...
| `sub_17E52` | `sub_1AFE2(目標記錄指標)` 是總入口，唯一呼叫端是 `sub_17E52`（一次攻擊）。 | `docs/re/09-2combat-map.md:49`, `docs/re/09-2combat-map.md:268`, `docs/re/09-2combat-map.md:392` |
...
| `sub_18056` | sub_18056() 印 " casts"，正常施展 | `docs/formats/08-combat.md:252`, `docs/re/09-2combat-map.md:168`, `docs/re/09-2combat-map.md:394` |
| `sub_180C6` | `sub_180C6`／`sub_1814A` | `docs/re/09-2combat-map.md:393` |
| `sub_1814A` | 相鄰的 bit6 進 `ds:9E35`，170 隻有）。`ds:9E35` 在 `2COMBAT sub_1814A` | `docs/formats/02-data-files.md:765`, `docs/re/09-2combat-map.md:393` |
| `sub_18290` | 的單一目標由 `sub_18290` 挑，用的是同一套走法。 | `docs/re/09-2combat-map.md:377`, `docs/re/09-2combat-map.md:395` |
| `sub_18302` | `sub_18302` | `docs/re/09-2combat-map.md:396` |
...
| `sub_1845A` | 只有 `sub_1845A`／`sub_190C0` 會設 1，而每個怪物動作結束時 `sub_184FE` | `docs/formats/08-combat.md:198`, `docs/re/09-2combat-map.md:278`, `docs/re/09-2combat-map.md:397` |
| `sub_1846C` | `sub_1845A`／`sub_1846C` | `docs/formats/08-combat.md:196`, `docs/re/09-2combat-map.md:397` |
...
| `sub_18B3E` | `sub_18B3E` | `docs/re/09-2combat-map.md:398` |
| `sub_18BAE` | `sub_18BAE` | `docs/re/09-2combat-map.md:399` |
...
| `sub_190EC` | `sub_190EC` | `docs/re/09-2combat-map.md:400` |
...
| `sub_191CC` | 指令列的繪製與選擇；`sub_1926A(字串, 位置)` 查 `ds:0FFC`／`ds:1006` 的座標表與 `ds:0FD8` 的字串表 | `docs/re/09-2combat-map.md:401` |
| `sub_191EC` | `sub_191EC` | `docs/formats/07-event-script.md:111` |
| `sub_1926A` | 指令列的繪製與選擇；`sub_1926A(字串, 位置)` 查 `ds:0FFC`／`ds:1006` 的座標表與 `ds:0FD8` 的字串表 | `docs/re/09-2combat-map.md:401` |
| `sub_1929A` | 指令列的繪製與選擇；`sub_1926A(字串, 位置)` 查 `ds:0FFC`／`ds:1006` 的座標表與 `ds:0FD8` 的字串表 | `docs/re/09-2combat-map.md:401` |
| `sub_193B2` | `sub_193B2` | `docs/re/09-2combat-map.md:402` |
...
| `sub_195A8` | `sub_195A8(槽)` | `docs/re/09-2combat-map.md:403` |
| `sub_195DC` | `sub_195DC` | `docs/re/09-2combat-map.md:404` |
...
| `sub_197E6` | `sub_197E6`／`sub_198FE`／`sub_199B8` | `docs/re/09-2combat-map.md:405` |
...
| `sub_198FE` | `sub_199B8` 反覆加怪直到 `sub_198FE` 判定湊夠了： | `docs/formats/08-combat.md:344`, `docs/re/09-2combat-map.md:405` |
...
| `sub_199B8` | `sub_199B8` 反覆加怪直到 `sub_198FE` 判定湊夠了： | `docs/formats/07-event-script.md:307`, `docs/formats/08-combat.md:344`, `docs/re/09-2combat-map.md:405` |
| `sub_199C8` | `sub_199C8` | `docs/re/09-2combat-map.md:406` |
...
| `sub_19A3C` | `sub_19B88` 生成 0–3 件物品；每件 `sub_19A3C` 依 `ds:10EA/10F6` 遭遇 band | `docs/formats/02-data-files.md:53`, `docs/formats/08-combat.md:753`, `docs/polish-spec.md:130` 等 6 處 |
...
| `sub_1A086` | `sub_1A086` | `docs/re/09-2combat-map.md:407` |
...
| `sub_1A202` | `ds:03C8` 全十五個資料庫**只有一處寫**（`2PLAY sub_1A202`，事件 opcode | `docs/formats/07-event-script.md:148`, `docs/polish-spec.md:96` |
...
| `sub_1A77E` | `sub_1A77E` | `docs/re/09-2combat-map.md:408` |
...
| `sub_1A9E2` | `sub_1A9E2` | `docs/re/09-2combat-map.md:409` |
...
| `sub_1AB02` | `sub_1AB02(法術)` | `docs/re/09-2combat-map.md:410` |
...
| `sub_1AFE2` | `sub_1AFE2(目標記錄指標)` 是總入口，唯一呼叫端是 `sub_17E52`（一次攻擊）。 | `docs/re/09-2combat-map.md:49`, `docs/re/09-2combat-map.md:392` |
...
| `sub_1B116` | 4.3 傷害怎麼分配（`sub_1B116`） | `docs/re/09-2combat-map.md:201`, `docs/re/09-2combat-map.md:240`, `docs/re/09-2combat-map.md:411` |
| `sub_1B1D4` | 場景碼 `ds:039C` 由 `sub_1B1D4` 從 `ATTRIB.DAT` 的 `+4` 算出來， | `docs/formats/07-event-script.md:622` |
| `sub_1B226` | `sub_1B226(隊員)` 是單一目標的收尾：先讓 `sub_17E10` 依三個抗性旗標調整 | `docs/re/09-2combat-map.md:248`, `docs/re/09-2combat-map.md:266`, `docs/re/09-2combat-map.md:412` |
| `sub_1B2C2` | `sub_1B2C2` | `docs/re/09-2combat-map.md:413` |
| `sub_1B2DE` | `sub_1B2DE(目標)` 擲一次 `rand(1,100)`，依序試三個通道，**第一個擋下的就結束**， | `docs/polish-spec.md:295`, `docs/re/09-2combat-map.md:310`, `docs/re/09-2combat-map.md:318` 等 6 處 |
| `sub_1B362` | 骰子顆數是怪物編號的高 4 位**（`sub_1B362`）： | `docs/re/09-2combat-map.md:232`, `docs/re/09-2combat-map.md:415` |
...
| `sub_1B410` | `sub_1B3A8(位元)`：對每個隊員跑一次 `sub_1B410`，而且**每次都把三個抗性旗標 | `docs/formats/06-map.md:527`, `docs/polish-spec.md:37`, `docs/re/09-2combat-map.md:353` 等 6 處 |
...
| `sub_1B530` | `sub_1B530` | `docs/re/09-2combat-map.md:419` |
| `sub_1B558` | `sub_1B558` | `docs/re/09-2combat-map.md:420` |
| `sub_1B58E` | `sub_1B58E` | `docs/re/09-2combat-map.md:421` |
| `sub_1B5C8` | 原版行為。** `sub_1B5C8` 逐一看 `ds:0416[i]`：名冊索引 24 以上的雇傭兵 | `docs/polish-spec.md:309`, `docs/re/09-2combat-map.md:422`, `docs/re/09-2combat-map.md:435` |
...
| `sub_1B62E` | `sub_1B62E` | `docs/re/09-2combat-map.md:423` |
| `sub_1B6C2` | `sub_1B6C2` | `docs/re/09-2combat-map.md:424` |
| `sub_1B70C` | 怪物特殊攻擊 case 2 2COMBAT sub_1B70C cmp 0FFh / inc ← 施加，上限 255 | `docs/formats/08-combat.md:1082`, `docs/polish-spec.md:293`, `docs/re/09-2combat-map.md:175` 等 8 處 |
...
| `sub_1BB2C` | 戰鬥中用物品：走 `2CAST1` 的施法入口或 `sub_171CE` 的即時效果 | `docs/re/09-2combat-map.md:426` |
...
| `sub_1C1D2` | `_2play_e14`）與巫師系定位術（`2CAST1 sub_1C1D2` 經 thunk `0x172B2`）。 | `docs/formats/04-graphics.md:377`, `docs/formats/09-spells.md:90`, `docs/polish-spec.md:106` |
...
| `sub_1D262` | `sub_1D236`、`sub_1D262`、`sub_1D11A`、`sub_1D098`、`sub_1CF78` 九支逐條讀完； | `docs/re/05-2smith-control-room.md:205`, `docs/re/05-2smith-control-room.md:344` |
| `sub_1D2A4` | 等級：**已證實**（`_2smith_e01`、`sub_1D2A4`、`sub_1D19C`、`sub_1D1FC`、 | `docs/formats/02-data-files.md:1205`, `docs/polish-spec.md:214`, `docs/re/03-character-flags.md:42` 等 10 處 |
...
| `_1retinn_e00` | `ds:03D4` 由登記入住時寫（`_1retinn_e00`），落點查 `ds:21E8`／`21EE`／`21F4` | `docs/polish-spec.md:252`, `docs/re/06-1retinn-roster.md:12`, `docs/re/06-1retinn-roster.md:13` 等 6 處 |
| `_1retinn_e01` | `1RETINN _1retinn_e01` 另外把 `ds:039C` 設成 7（旅店名冊畫面，不在世界裡）。 | `docs/polish-spec.md:61`, `docs/polish-spec.md:251`, `docs/re/06-1retinn-roster.md:13` 等 8 處 |
...
| `_1retinn_e04` | `1RETINN _1retinn_e04`／`_1retinn_e03`；`ds:21E8`／`21EE`／`21F4`（[`docs/re/06`](re/06-1retinn-roster.md)） | `docs/polish-spec.md:27`, `docs/polish-spec.md:250`, `docs/re/06-1retinn-roster.md:13` 等 6 處 |
...
| `_2misc_e02` | 否則進 `2MISC _2misc_e02` —— 而 `_2misc_e02` 的 thunk **全域只有這一個呼叫端**。 | `docs/formats/08-combat.md:682`, `docs/formats/08-combat.md:742`, `docs/polish-spec.md:149` 等 11 處 |
| `_2misc_e03` | `2MISC +CF84`（`_2misc_e03`） | `docs/research/command-keys-oracle.md:31` |
| `_2play_e00` | [`chest-trigger-oracle`](chest-trigger-oracle.md) 先前把 `_2play_e00` | `docs/polish-spec.md:107`, `docs/re/01-boot-and-display-mode.md:18`, `docs/research/chest-trigger-oracle.md:68` 等 5 處 |
| `_2play_e02` | 原版依據。** `2PLAY _2play_e02`（`0x18517`）查 `ATTRIB.DAT` `+32`…`+63` | `docs/formats/02-data-files.md:863`, `docs/polish-spec.md:76` |
| `_2play_e03` | 回傳值直接當 `SKY.16` 的影格編號（`_2play_e03` 的 `0x18773`）： | `docs/formats/02-data-files.md:873`, `docs/polish-spec.md:78` |
...
| `_2play_e10` | 判準是**原版的場景碼**不是猜的：`2PLAY _2play_e10` 是 7 個 case 的 switch， | `docs/formats/02-data-files.md:907`, `docs/formats/04-graphics.md:361`, `docs/music.md:31` 等 4 處 |
| `_2play_e11` | `_2play_e11`（`0x1B6C7`）把結果寫進 `ds:039C`： | `docs/polish-spec.md:38` |
| `_2play_e13` | 由 `_2play_e13`（含一個 5×5 的迴圈）與 `_2play_e14` 透過 `sub_16EF2` | `docs/formats/04-graphics.md:362` |
| `_2play_e14` | 過關之後呼叫 `_2play_e00` 與 `_2play_e14`（thunk `0x172B2`）—— 它用 `.16` 的 | `docs/formats/04-graphics.md:362`, `docs/formats/04-graphics.md:377`, `docs/polish-spec.md:107` 等 5 處 |
...
| `_2smith_e01` | 原版依據。** `2PLAY sub_19716` 的 `0xFD` → 2SMITH `_2smith_e01`（`+CEC8`） | `docs/polish-spec.md:213`, `docs/re/05-2smith-control-room.md:12`, `docs/re/05-2smith-control-room.md:25` 等 9 處 |
...
| `sub_17EAF` | （`sub_17EAF` 的 `cmp ds:59C8, 0x80` 先擋掉）。 | `internal/game/session.go:450` |
| `sub_1C1BC` | 原版的兩個索引都可以按 Esc 取消（`sub_1C1BC` 回 `0x1B`）， | `internal/ui/session.go:2357` |
