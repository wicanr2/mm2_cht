...
| P15 | `2CAVES` 十支特殊裝置：座標傳送機、滑梯陷阱、隨機遭遇、三個架子、捐黃金／寶石換經驗、三倍泉、生命上限重算、馬戲團、年代之門 | [`docs/re/02`](re/02-2caves-special-events.md) | `internal/game/cave_test.go` 十三條 ＋ `internal/ui/cave_internal_test.go` 三條 |
