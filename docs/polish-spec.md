...
| P15 | `2CAVES` 五支特殊裝置：座標傳送機、滑梯陷阱、捐黃金／寶石換經驗、年代之門 | [`docs/re/02`](re/02-2caves-special-events.md) | `internal/game/cave_test.go` 六條 ＋ `internal/ui/cave_internal_test.go` 三條 |
