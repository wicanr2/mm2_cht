...
| ~~A2~~ | Mega Drive 的場景素材 | **解完並接進 `F6`**：素材、版面、地板、天空、調色盤（`0x6FBEA` 起四條 16 色）都解出來了，見 [`research/02`](research/02-other-platforms.md)。剩一項小的：哪一套素材配哪一條調色盤線 —— 方石砌那套用第 0 條已證實，粗石與戶外用第 1 條看起來合理但只是**假設**，要拿執行時的 CRAM 裁決 |
