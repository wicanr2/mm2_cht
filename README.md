...
**可以玩了。** 走路、事件、戰鬥、施法、商店、旅店、神殿、訓練、存檔都接上了；
翻譯 100% 完成。角色創建與搜尋寶箱還沒做。

![第一人稱視角](docs/screenshots/01-first-person.png)

牆與地板來自原版素材，側牆的火炬會動；中文走獨立的高解析點陣層疊在上面，
原版的 320×200 骨架一個像素都沒改。更多畫面見
...
I 物品、B 商店、K 查說明書、M 地圖、D 撞門、U 開鎖、S 存檔；
